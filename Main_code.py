...
from Chen_text_to_video_copy_copy import add_list_of_texts_with_special_words_color
from select_random_specialword import extract_word_pairs
...
list_màu=["red", "blue", "green", "yellow", "orange"]
...
def main_code(input_video , output_video , text , audio_file):
    ...
    random_màu = random.sample(list_màu, 2)
    start_pos = 0
    ...
    add_list_of_texts_with_special_words_color(input_video, output_video, list_texts, list_time_intervals, audio_file , special_words=special_words, list_màu=random_màu)
