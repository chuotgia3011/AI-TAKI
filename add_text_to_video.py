...
# def add_list_of_texts_with_special_words_color(input_video, output_video, list_texts, list_time_intervals, fontsize=50, default_color='white', special_words=None, list_color=None, font="/usr/local/share/fonts/roboto/Roboto-Regular.ttf"):
...
def add_list_of_texts_with_special_words_color(input_video, output_video, list_texts, list_time_intervals, audio_file,
                                               fontsize=70, default_color='white', special_words=None, list_color=None,
    ...
    :param list_color: Danh sách các màu cho từ đặc biệt, sẽ chọn ngẫu nhiên.
    ...
    if list_color is None:
        list_color = ['red']  # Nếu không có danh sách màu, mặc định là màu đỏ
                    ...
                    if start_index != -1 and start_index <= words.index(word) < start_index + len(special_word.split()):
                        if special_word not in phrase_color_map:
                            phrase_color_map[special_word] = random.choice(
                                list_color)  # Chọn màu ngẫu nhiên cho cụm từ nếu chưa có
...
# list_color = ["red", "blue", "green", "yellow"]  # Danh sách các màu ngẫu nhiên


# list_texts = result
# add_list_of_texts_with_special_words_color(input_video, output_video, list_texts, list_time_intervals, audio_file , special_words=special_words, list_color=list_color)
