...
def add_list_of_texts_with_special_words_color(input_video, output_video, list_texts, list_time_intervals, audio_file, fontsize=70, default_color='white', special_words=None, list_màu=None, font="/usr/local/share/fonts/Anton/Anton-Regular.ttf"):
    """
    ...
    for idx, texts in enumerate(list_texts):
        ...
        for i, text in enumerate(texts):
            ...
            for word in words:
                ...
                for special_word in special_words:
                    ...
                    if start_index != -1 and start_index <= words.index(word) < start_index + len(special_word.split()):
                        if special_word not in phrase_color_map:
                            phrase_color_map[special_word] = random.choice(list_màu)  # Chọn màu ngẫu nhiên cho cụm từ nếu chưa có
                ...
                word_clip = TextClip(word, fontsize=fontsize, color=word_color, font=font , stroke_color='black', stroke_width=1 ,  method='label')
            ...
            for word in words:
                ...
                word_clip = TextClip(word, fontsize=fontsize, color=word_color, font=font , stroke_color='black', stroke_width= 2 ,  method='label')
